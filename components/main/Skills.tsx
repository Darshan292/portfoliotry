...
const Skills = () => {
    ...
    return (
        ...
        >  
          <p className="text-5xl mt-[60px] max-lg:mt-6 font-semibold text-transparent bg-clip-text bg-gradient-to-r from-blue-500 to-blue-100 max-md:text-4xl max-sm:text-3xl max-[350px]:text-2xl">Skills</p>

          <div className="flex flex-row items-center justify-center gap-52 h-full relative overflow-hidden  z-40 max-lg:flex-col max-lg:gap-0">
